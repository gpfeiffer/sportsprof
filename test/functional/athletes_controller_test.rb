...
class AthletesControllerTest < ActionController::TestCase
  ...
  test "should create athlete" do
    assert_difference('Athlete.count') do
      post :create, athlete: { date_of_birth: @athlete.date_of_birth, first_name: @athlete.first_name, gender: @athlete.gender, last_name: @athlete.last_name }
    end
  ...
  test "should update athlete" do
    put :update, id: @athlete, athlete: { date_of_birth: @athlete.date_of_birth, first_name: @athlete.first_name, gender: @athlete.gender, last_name: @athlete.last_name }
    assert_redirected_to athlete_path(assigns(:athlete))
  end
